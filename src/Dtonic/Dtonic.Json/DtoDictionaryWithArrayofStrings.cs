...
public sealed record DtoDictionaryWithArrayOfStrings : DtoValueBase<IDictionary<string, IEnumerable<string?>?>>
{
    ...
    private string GetDebuggerDisplay() => GetDebuggerDisplay(nameof(DtoDictionaryWithArrayOfStrings), _value);
    ...
    public override string Stringify()
    {
        ...
        foreach (var item in Value)
        {
            ...
            else
            {
                ...
                {
                    arrayBob.Add(arrayItem is null ? NULL : arrayItem.JsonEscape());
                }
